...
export default function FichaCliente({ cliente, doc, actualizar, onCerrar }) {
  ...
  const guardarCambios = () => {
    const importe = Number(borrador.importe) || 0;
    const semanasTotal = semanasDeModalidad(borrador.modalidad);
    actualizar((d) => ({
      ...d,
      clientes: d.clientes.map((c) =>
        c.id === cliente.id
          ? {
              ...c,
              ...borrador,
              nombre: String(borrador.nombre || "").trim(),
              importe,
              semanasTotal,
    ...
    >
      ...
      <div className="ficha-seccion">
        ...
        <div className="form-grid">
          <Campo label="Nombre" value={borrador.nombre} onChange={set("nombre")} ancho={2} />
      ...
      <div className="ficha-seccion">
        ...
        <div className="pista" style={{ marginTop: 8 }}>
          El registro de la renovación (cambio de ciclo + cobro) llega en la Fase 3.
        </div>
      </div>
